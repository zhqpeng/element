...
import locale from 'element-ui-lw-etc/lib/locale/lang/en'
...
import lang from 'element-ui-lw-etc/lib/locale/lang/en'
import locale from 'element-ui-lw-etc/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/element-ui-lw-etc[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'element-ui-lw-etc/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'element-ui-lw-etc/lib/locale/lang/en'
import zhLocale from 'element-ui-lw-etc/lib/locale/lang/zh-CN'
...
import enLocale from 'element-ui-lw-etc/lib/locale/lang/en'
import zhLocale from 'element-ui-lw-etc/lib/locale/lang/zh-CN'
import ElementLocale from 'element-ui-lw-etc/lib/locale'
...
<script src="//unpkg.com/element-ui-lw-etc"></script>
<script src="//unpkg.com/element-ui-lw-etc/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/element-ui-lw-etc"></script>
<script src="//unpkg.com/element-ui-lw-etc/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/element-ui-lw-etc/lib/umd/locale/en.js"></script>
